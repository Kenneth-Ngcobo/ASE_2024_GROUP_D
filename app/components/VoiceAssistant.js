...
//             setCurrentStep(0); // Reset to the beginning if step index goes out of range
//         }
//     }, [instructions]);
...
//                 utterance.rate = speechSpeed;
//                 utterance.onend = () => {
//                     const nextIndex = (index + 1) % instructions.length; // Reset to the first step after the last one
...
//     const goToNextStep = () => {
//         const nextStep = (currentStep + 1) % instructions.length; // Cycle back to the first step if on the last one
//         setCurrentStep(nextStep);
//         readInstruction();
//     };

//     const goToPreviousStep = () => {
//         const prevStep = currentStep === 0 ? instructions.length - 1 : currentStep - 1; // Go to the last step if on the first one
...
export default function VoiceAssistant({ instructions }) {
    ...
    // Monitor changes to `currentStep` and read the instruction
    useEffect(() => {
