...
import { getRecipeFromIndexedDB } from "../../../lib/idb"; // IndexedDB fallback function
...
const fetchRecipeData = async (id) => {
  try {
    ...
    // If API fetch fails, fall back to IndexedDB
    const offlineRecipe = await getRecipeFromIndexedDB(id);
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white dark:bg-gray-950 rounded-2xl shadow-xl p-6 overflow-hidden">
                ...
                <div className="flex flex-col justify-center space-y-4">
                  ...
                  {/* Allergens Section */}
                  <AllergensSection recipeId={recipe.id} />
                  {/* Editable Recipe Details */}
                  <EditableRecipeDetails recipe={recipe} />
